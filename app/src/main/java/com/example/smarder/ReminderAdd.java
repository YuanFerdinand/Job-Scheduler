...
import com.example.smarder.database.AlarmReminderContract;
import com.example.smarder.reminder.AlarmScheduler;
import com.google.android.material.floatingactionbutton.FloatingActionButton;

import java.util.Calendar;

public class ReminderAdd extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDay = mCalendar.get(java.util.Calendar.DATE);
    ...
    public void setTime(View v){
        ...
        int hourOfDay = now.get(java.util.Calendar.HOUR_OF_DAY);
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mVehicleHasChanged) {
                    NavUtils.navigateUpFromSameTask(ReminderAdd.this);
                    return true;
                }
    ...
    public void saveReminder(){
        ...
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_DATE, (String) mDateText.getText());
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_TIME, (String) mTimeText.getText());
        ...
        mCalendar.set(java.util.Calendar.DAY_OF_MONTH, mDay);
        mCalendar.set(java.util.Calendar.HOUR_OF_DAY, mHour);
        mCalendar.set(java.util.Calendar.MINUTE, mMinute);
        ...
        if (mCurrentReminderUri == null) {
            mCurrentReminderUri = AlarmReminderContract.AlarmReminderEntry.CONTENT_URI;
            Uri newUri = getContentResolver().insert(mCurrentReminderUri, values);
